...
run:async (client, message, args) => {
  ...
  if (!channel) {
    let embed = new MessageEmbed()
      .setColor("428CCF")
      .setDescription("<:emoji_42:763352436139098123> Pleae connect with a voice channel")
  ...
  if (!args.length) {
    let embed = new MessageEmbed()
      .setColor("428CCF")
      .setDescription(`<:emoji_42:763352436139098123> provide  me song name or url link!`)
    return message.channel.send(embed)
  }
  ...
  if (player.options.voiceChannel !== channel.id) {
    let embed = new MessageEmbed()
      .setColor("428CFF")
      .setDescription(`<:emoji_42:763352436139098123> Must join ${channel}`)
    return message.channel.send(embed)
  }
